...
- พัฒนาทักษะพื้นฐานสำหรับการบริหารจัดการระบบ IoT ด้วย DevOps เรียนรู้โครงสร้างพื้นฐานของระบบปฏิบัติการ Linux ซึ่งเป็นหัวใจสำคัญของระบบ Cloud และ IoT
- สร้างความเข้าใจในแนวคิดและกระบวนการ DevOps ผสานการทำงานระหว่างการพัฒนา (Development) และการปฏิบัติการ (Operations) เพื่อเพิ่มความเร็วและความยืดหยุ่นในการพัฒนา IoT Service
- ตั้งค่าระบบและบริหารจัดการ IoT Platform ตั้งแต่การ Spin-Up Service, การตั้งค่าเซิร์ฟเวอร์, และการใช้งาน Container (Docker)
- สร้างทักษะในการใช้งานเครื่องมือ DevOps สำหรับ IoT ใช้งาน CI/CD Pipeline เพื่ออัปเดตและปรับปรุงระบบ IoT อย่างมีประสิทธิภาพ เตรียมความพร้อมสู่การ Deploy IoT Solution
- สร้างและนำระบบ IoT ไปใช้งานจริง บนระบบ Cloud หรือ Edge Device
- เข้าใจ concept และปฏิบัติบนพื้นฐานและหลักการของ OWASP ได้

## Projects

- **Linux Setup**  
  สำหรับการติดตั้งและปรับแต่งระบบ Linux เพื่อเตรียมความพร้อมสำหรับงาน DevOps

- **Containerization**  
  นำเสนอการใช้เทคโนโลยี container (เช่น Docker) สำหรับการ deploy services

- **CI/CD Pipeline**  
  อธิบายกระบวนการ continuous integration และ continuous deployment เพื่อเพิ่มประสิทธิภาพในการพัฒนา

- **Monitoring System**  
  แสดงการตั้งค่าระบบ monitoring เพื่อตรวจสอบและรักษาความเสถียรของบริการ

...
- [🚢 การสร้างและจัดการระบบแบบ Container Orchestration (Kubernetes)](#-การสร้างและจัดการระบบแบบ-container-orchestration-kubernetes)
  ...
  - [5. 🔄 การ Deploy แอปพลิเคชันบน Kubernetes](#5--การ-deploy-แอปพลิเคชันบน-kubernetes)
    ...
    - [5.4 🔤 ตัวย่อและชื่อทรัพยากรใน Kubernetes](#54--ตัวย่อและชื่อทรัพยากรใน-kubernetes)
      - [5.4.1 ตัวย่อสำหรับคำสั่ง kubectl](#541-ตัวย่อสำหรับคำสั่ง-kubectl)
      - [5.4.2 ตารางตัวย่อของ Kubernetes Resources/Objects](#542-ตารางตัวย่อของ-kubernetes-resourcesobjects)
...
### 5.4 🔤 ตัวย่อและชื่อทรัพยากรใน Kubernetes

ในการทำงานกับ Kubernetes ประจำวัน คุณจะพบตัวย่อที่ใช้บ่อยซึ่งช่วยให้การพิมพ์คำสั่งเร็วขึ้น และช่วยในการสื่อสารในทีมได้อย่างมีประสิทธิภาพ

#### 5.4.1 ตัวย่อสำหรับคำสั่ง kubectl
...
#### 5.4.2 ตารางตัวย่อของ Kubernetes Resources/Objects
